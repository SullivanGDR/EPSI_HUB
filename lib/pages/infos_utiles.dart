        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              subtitle: const Text("03 21 71 33 34"),
            ),
            ListTile(
              leading: Icon(Icons.email, color: Colors.blue.shade900),
              title: const Text("Email :"),
              subtitle: const Text("info@arras-epsi.fr"),
            ),
            const SizedBox(height: 16),
            ...
            Column(
              ...
              children: [
                ListTile(
                  ...
                  title: const Text("Réféctoire"),
                  subtitle: const Text("Ouverte de 8h30 à 17h30"),
                ),
                ListTile(
                  leading: Icon(Icons.wifi, color: Colors.blue.shade900),
                  title: const Text("Wi-Fi gratuit"),
                  subtitle: const Text("Nom du réseau : COMDEV-PEDAGO"),
                ),
                ListTile(
                  leading:
                  Icon(Icons.computer, color: Colors.blue.shade900),
                  title: const Text("Laboratoire MyDil"),
                  subtitle: const Text("Accès au matériel durant les heures d'ouverture"),
                ),
              ],
            ),
            const SizedBox(height: 16),
            ...
            Column(
              ...
              children: [
                ListTile(
                  ...
                  title: const Text("Transports publics"),
                  subtitle: const Text("Arrêt de bus à proximité : Ligne 2 - Dépôt, Ligne 6/7 : Lobbedez"),
                ),
                ListTile(
                  leading: Icon(Icons.restaurant, color: Colors.blue.shade900),
                  title: const Text("Restaurants"),
                  subtitle: const Text("Restaurant Universitaire d'Arras"),
                ),
              ],
            ),
            const SizedBox(height: 16),
            ...
            Center(
              child: ElevatedButton(
                ...
                child: const Text("Contacter le campus"),
              ),
            ),
            const SizedBox(height: 16),
          ],
